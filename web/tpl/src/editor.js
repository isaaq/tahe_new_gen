...
function Editor(container_id, options) {
    ...
    this.addToolsButton(
        "playnode_button",
        "Play",
        "http://127.0.0.1:8000/editor/imgs/icon-play.png",
    ...
    this.addToolsButton(
        "playstepnode_button",
        "Step",
        "http://127.0.0.1:8000/editor/imgs/icon-playstep.png",
    ...
    if (!options.skip_livemode) {
        this.addToolsButton(
            "livemode_button",
            "Live",
            "http://127.0.0.1:8000/editor/imgs/icon-record.png",
    ...
    if (!options.skip_maximize) {
        this.addToolsButton(
            "maximize_button",
            "",
            "http://127.0.0.1:8000/editor/imgs/icon-maximize.png",
