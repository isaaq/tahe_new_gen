...
module Plugins
  module Strategy
    module Notification
      class MultiChannelNotificationStrategy < ::Strategy::BaseStrategy
        # 自动注册策略
        strategy_for 'notification', 'notify', 'multi_channel'
        ...
        def before_execute(params = {})
          ...
          raise "缺少必要参数: channels" unless params[:channels]
